...
public class SearchStudentForm extends JPanel {
	...
	public SearchStudentForm() {
		...
		if (jCheckBox6.isSelected() || jCheckBox7.isSelected() || jCheckBox8.isSelected()) {
	...
	private void initComponents() {
		...
		add(getJButton0(), new Constraints(new Leading(511, 10, 10), new Leading(909, 12, 12)));
		add(getJButton1(), new Constraints(new Leading(384, 10, 10), new Leading(909, 12, 12)));
		...
		if (jCheckBox8 == null) {
			...
			jCheckBox8.addItemListener(new ItemListener() {
				...
				public void itemStateChanged(ItemEvent event) {
					jCheckBox8ItemItemStateChanged(event);
				}
			});
		}
		return jCheckBox8;
	...
	private JPanel getJPanel3() {
		if (jPanel3 == null) {
			...
			jPanel3.add(getJLabel23(), new Constraints(new Trailing(20, 10, 518), new Leading(-10, 10, 10)));
			jPanel3.add(getJCheckBox4(), new Constraints(new Leading(5, 93, 10, 10), new Leading(8, 8, 8)));
			jPanel3.add(getJCheckBox5(), new Constraints(new Leading(108, 93, 10, 10), new Leading(8, 8, 8)));
			jPanel3.add(getJCheckBox6(), new Constraints(new Leading(198, 62, 10, 10), new Leading(8, 8, 8)));
			jPanel3.add(getJCheckBox7(), new Constraints(new Leading(291, 100, 10, 10), new Leading(8, 8, 8)));
			jPanel3.add(getJCheckBox8(), new Constraints(new Leading(416, 71, 10, 10), new Leading(8, 10, 4)));
			jPanel3.add(getJSpinner0(), new Constraints(new Trailing(12, 41, 423, 448), new Leading(11, 19, 10, 7)));
		}
		return jPanel3;
	}
	...
	private JLabel getJLabel22() {
		if (jLabel22 == null) {
			jLabel22 = new JLabel();
			jLabel22.setText("* Click the row to get Information in the above Fields !");
		}
		return jLabel22;
	}
	...
	private void initButtonGroup1() {
		...
		buttonGroup1.add(getJCheckBox8());
	}
	...
	public void searchAllStudent() {
		...
		studentID = new StudentSearchUtilities().getAllStudents();
		multipleRecordSearch();
	...
	private void jCheckBox8ItemItemStateChanged(ItemEvent event) {
