...
public class BillingRecordForm extends JPanel {
	...
	private void initComponents() {
		...
		add(getDueDatePicker(), new Constraints(new Leading(160, 129, 12, 12), new Leading(454, 26, 12, 12)));
		add(getJLabel7(), new Constraints(new Leading(66, 78, 12, 12), new Leading(459, 10, 103)));
		add(getJLabel4(), new Constraints(new Leading(66, 78, 12, 12), new Leading(498, 10, 64)));
		add(getJTextField2(), new Constraints(new Leading(160, 129, 12, 12), new Leading(493, 26, 12, 12)));
		add(getJButton0(), new Constraints(new Leading(160, 10, 144), new Leading(535, 10, 10)));
		setSize(350, 578);
	}
	...
	private JXDatePicker getDueDatePicker() {

		if (dueDatePicker == null) {
			dueDatePicker = new JXDatePicker(new Date());
		}
			...
			jTextField0.addFocusListener(new FocusAdapter() {
				...
				public void focusLost(FocusEvent e) {
					...
					if (studentExist) {
						...
						JOptionPane.showMessageDialog(null, "Student ID: "+jTextField0.getText()+" Exist!");
						studentRecordSearch();

					} else {

						JOptionPane.showMessageDialog(null, "Student ID: "+jTextField0.getText()+" not Exist!");
	...
	public void studentRecordSearch() {
		...
		try {
			...
			data = ServiceUtilities.getServicesWithChargesForStudent(jTextField0.getText());
